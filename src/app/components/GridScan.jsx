...
export const GridScanBackground = ({
  lineThickness = 1,
  linesColor = '#392e4e',
  scanColor = '#FF9FFC',
  scanOpacity = 0.4,
  ...
  useEffect(() => {
    ...
    const uniforms = {
      ...
      iTime: { value: 0 },
      uSkew: { value: new THREE.Vector2(0, 0) }, // Fixed at zero - no mouse interaction
      uTilt: { value: 0 }, // Fixed at zero - no mouse interaction
      uYaw: { value: 0 }, // Fixed at zero - no mouse interaction
    ...
    const tick = () => {
      ...
      // All interaction values remain fixed at zero
